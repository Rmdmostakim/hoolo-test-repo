...
function Beauty(props) {
  ...
  return (
    <>
            ...
            <div   >
            <span style={{fontSize:'18px', fontWeight:'700', color:'#333'}}> Beauty & Personal Care </span> 
		  ...
		  <Slider {...settings} className="mb-5"  >
             
                  {
                   ...
                   product.category_id==4 &&  <ProductSlide key={product.id} img={product.thumbnail} offer_price={product.offer_price} price={product.price} product_name={JSON.parse(product.product_name).en}  id={product.id} />
                    ))
                }
